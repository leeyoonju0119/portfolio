...
import com.portfolio.service.AdProductService;
import com.portfolio.util.FileUtils;
...
public class AdProductController {
	...
	private String uploadCkEditorPath;  // C:\\dev\\upload\\ckeditor\\
		...
		public ResponseEntity<List<CategoryVO>> subCategory(@PathVariable("cat_code") Integer cat_code) { // @PathVariable - Type2의 URl을 처리할 때 사용
