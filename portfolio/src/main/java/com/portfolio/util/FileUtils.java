	...
	public static String uploadFile(String uploadFolder, String uploadDateFolder, MultipartFile uploadFile) {
		...
		try {
			...
			if(checkImageType(saveFile)) {
				...
				Thumbnailator.createThumbnail(uploadFile.getInputStream(), thumnail, 100, 100); // 썸네일
			...
			ex.printStackTrace(); // printStackTrace - 예외발생 당시의 호출스택에 있었던 메서드의 정보와 예외 메세지를 화면에 출력한다.
		}
