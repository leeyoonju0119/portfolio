      ...
      <div>
        ...
        <div class="row border-top pt-3">
          ...
          <div class="row pt-3">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control" name="ord_addr_num" id="sample2_postcode">
    ...
    $(document).ready(function() {
      ...
      $("[name='btn_buy']").on("click", function() {
        ...
        let order_info = {
          ...
          ord_addr_num : $("input[name='ord_addr_num']").val(),
      ...
      console.log("order_productName: " + order_info.order_productName);
      console.log("ord_name: " + order_info.ord_name);
      console.log("ord_addr_num: " + order_info.ord_addr_num);
      console.log("ord_addr_basic: " + order_info.ord_addr_basic);
      console.log("ord_addr_detail: " + order_info.ord_addr_detail);
      console.log("ord_tel: " + order_info.ord_tel);
      console.log("ord_price: " + order_info.ord_price);
      console.log("pay_method: " + order_info.pay_method);
      console.log("pay_price: " + order_info.pay_price);
      console.log("pay_user: " + order_info.pay_user);
      console.log("pay_bank: " + order_info.pay_bank);
      console.log("pay_memo: " + order_info.pay_memo);
