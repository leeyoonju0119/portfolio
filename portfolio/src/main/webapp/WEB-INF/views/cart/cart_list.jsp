...
<div class="container">
 ...
 <div class="row">
 	<div class="col-md-12 text-center">
 		...
 		<button type="button" id="btn_keep_shopping" class="btn btn-light">계속 쇼핑하기</button>
 		<button type="button" id="btn_order_now" class="btn btn-dark">주문하기</button>
 	</div>
 </div>
  ...
  <%@include file="/WEB-INF/views/include/footer.jsp" %>
   ...
   <script>
	...
	// 주문하기
	$("#btn_order_now").on("click", function() {
